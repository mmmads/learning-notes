...
```
 ...
 的错配，“acgtn”表示负链上的错配。此模式“\\+[0-9]+[ACGTNacgtn]+”表示在此位点至下一个位点之间与参考基因组对应位点相比
 ，多了一段插入碱基，插入长度由模式中的整数表示。与此类似，“\\-[0-9]+[ACGTNacgtn]+”表示缺失，缺失的碱基使用“*”表示。
 同时，“^”表示reads的开始，“$”表示reads的结束。在“^”后的字符的ASCII码值减去33表示比对质量值。
